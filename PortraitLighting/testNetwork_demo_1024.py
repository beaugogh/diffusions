...
def light_portrait(img_name='obama', draw_light_reference=False):
    lightFolder = 'data/lightings_4/'
    ...
    img = cv2.imread(f'data/portraits/{img_name}.jpg')
    row, col, _ = img.shape
...
#     print(img_name)
#     draw_light_reference = False if i < len(imgs)-1 else True
#     light_portrait(img_name, draw_light_reference)


light_portrait('jayz', draw_light_reference=True)
